...
public class Forecast extends JFrame implements ActionListener{
	/**
	 * @author CRR
	 */
	...
	public void init()
	{
		...
		jl5 = new JLabel("请输入以'#'结尾的待分析串:");
		jl5.setFont(new Font(null, 1, 20));
		jl5.setBounds(420, 250, 300, 25);
		//输入文本框
		jtf = new JTextField();
		...
		//输入按钮，清空按钮
		jbut1 = new JButton("输入");
		jbut2 = new JButton("清空");
		jbut1.setBounds(672, 285, 60, 25);
		jbut2.setBounds(730, 285, 60, 25);
		...
		jscroll.setBounds(400, 320, 410, 155);
		jta.setOpaque(false);
		...
		jp2.setOpaque(false);
		jp2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)), "点击->生成分析表", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("宋体", 1, 20), new java.awt.Color(255, 255, 255)));
		jp2.add(button);
		jp1.add(jp2);
		
		jl6 = new JLabel("预 测 分 析 表");
		jl6.setBounds(600, 500, 300, 25);
		jl6.setFont(new Font(null, 1, 20));
		//分析表
		jt = new JTable();
	...
	public void analyse()
	{
		if(flag!=0)
		{
			...
			char fenxi[] = new char[100];//stack 分析栈
...
class NewPanelfore extends JPanel
{
	/**
	 * @author CRR
	 */
